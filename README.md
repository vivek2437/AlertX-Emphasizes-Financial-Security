...
*AlertX is an AI-driven SMS fraud detection assistant that protects users from scams by combining the power of BERT for classification and LLMs for explanations and alerts.*

* BERT Model: Classifies SMS as Normal or Fraudulent.
* LLM Layer: Generates category-specific alerts, safety tips, and explanations.
* Gradio UI: Provides a simple interface for testing in real time.

## ***Prototype Demo :-***


https://github.com/user-attachments/assets/f812c08a-45ac-4cbc-ae16-a61e88cf3644
